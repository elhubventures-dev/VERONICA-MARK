        ...
        <div className="page-split__main space-y-16">
          ...
          <div className="border-t border-[var(--color-border)] pt-12">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                href="/contact"
                className="inline-flex min-h-11 items-center justify-center bg-[var(--color-brand-deep)] px-7 text-sm font-semibold text-white transition-colors hover:bg-[color-mix(in_srgb,var(--color-brand-deep)_88%,black)]"
              >
                Contact us
              </Link>
              <Link
                href="/track-order"
                className="inline-flex min-h-11 items-center justify-center border border-[var(--color-border)] px-7 text-sm font-semibold transition-colors hover:bg-[var(--color-muted)]"
              >
                Track an order
              </Link>
            </div>
