...
export const adminLocales: AdminLocale[] = [
  { code: "en", name: "English", enabled: true, coveragePercent: 100, defaultCurrency: "EUR" },
  { code: "fr", name: "French", enabled: true, coveragePercent: 86, defaultCurrency: "EUR" },
  { code: "de", name: "German", enabled: false, coveragePercent: 42, defaultCurrency: "EUR" },
...
export const adminAnalytics = {
  ...
  platformHealth: 96,
  revenueSeries: [
    { day: "17 Jul", revenue: 4200, orders: 14 },
    { day: "18 Jul", revenue: 5100, orders: 17 },
    { day: "19 Jul", revenue: 3900, orders: 12 },
    { day: "20 Jul", revenue: 6400, orders: 21 },
    { day: "21 Jul", revenue: 5800, orders: 19 },
    { day: "22 Jul", revenue: 7200, orders: 23 },
    { day: "23 Jul", revenue: 8247, orders: 20 },
  ],
  brandMix: [
