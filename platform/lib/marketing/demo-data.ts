...
export const marketingPromotions: MarketingPromotion[] = [
  {
    ...
    redemptions: 412,
    revenueAttributed: 102630000,
  },
  {
    id: "promo-2",
    name: "Free shipping over ₦225,000",
    type: "FREE_SHIPPING",
    value: 0,
    status: "active",
    priority: 40,
...
export const marketingRewardRules: MarketingRewardRule[] = [
  {
    ...
    type: "earn",
    points: 1,
    description: "1 point per ₦1,500 spent (excl. shipping)",
    active: true,
  },
  {
    id: "rr-2",
    ...
    type: "redeem",
    points: 100,
    description: "100 points = ₦7,500 wallet credit",
    active: true,
  },
  {
    id: "rr-3",
...
export const marketingReferral: MarketingReferralStats = {
  ...
  currency: "NGN",
  topCodes: [
    { code: "CAMILLE-VM", owner: "Camille Dubois", conversions: 4, earned: 150000 },
    { code: "LOUIS-VM", owner: "Louis Moreau", conversions: 2, earned: 75000 },
    { code: "NORA-VM", owner: "Nora Ellis", conversions: 1, earned: 37500 },
  ],
};
...
export const marketingEmailCampaigns: MarketingEmailCampaign[] = [
  ...
  },
  {
    ...
    status: "draft",
    templateKey: "rewards.tier_upgraded",
