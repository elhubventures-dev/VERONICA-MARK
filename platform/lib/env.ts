...
const serverSchema = z.object({
  ...
  TWILIO_CONTENT_SID_ORDER_OUT_FOR_DELIVERY: optionalString,
  TWILIO_CONTENT_SID_ORDER_DELIVERED: optionalString,
...
function createServerEnv(): ServerEnv {
  if (shouldSkipStrictValidation) {
    return {
      ...
      TWILIO_CONTENT_SID_ORDER_PAID: process.env.TWILIO_CONTENT_SID_ORDER_PAID,
      TWILIO_CONTENT_SID_ORDER_SHIPPED: process.env.TWILIO_CONTENT_SID_ORDER_SHIPPED,
      TWILIO_CONTENT_SID_ORDER_OUT_FOR_DELIVERY: process.env.TWILIO_CONTENT_SID_ORDER_OUT_FOR_DELIVERY,
      TWILIO_CONTENT_SID_ORDER_DELIVERED: process.env.TWILIO_CONTENT_SID_ORDER_DELIVERED,
